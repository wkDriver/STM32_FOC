...
void Usart3_RS232_init(void)
{
  ...
  USART_InitStructure.USART_StopBits = USART_StopBits_1;//dingzhiwei 1
  USART_InitStructure.USART_Parity = USART_Parity_No;//meiyou jiou jiaoyanma
  USART_InitStructure.USART_HardwareFlowControl = USART_HardwareFlowControl_None;//meiyou  shujuliu kongzhi
